...
from segmentationApp.views import  MainView, SecondMain, file_upload_view, file_segment_view,start_region_growing, start_region_growing_parameters


urlpatterns = [
    path('admin/', admin.site.urls),
    path('', MainView.as_view(), name='main-view'),
    path('main/', SecondMain.as_view(), name='second-main-view'),
